...
import type { GitHubReleaseTagsClientConfig } from "./git-hub-release-tags-client-config.ts";

export class GitHubReleaseTagsClientImpl implements ReleaseTagsClient {
  readonly #repository: string;
  readonly #fetcher: (input: string, init?: RequestInit) => Promise<Response>;
  readonly #timeoutMs: number;

  constructor(config: GitHubReleaseTagsClientConfig) {
