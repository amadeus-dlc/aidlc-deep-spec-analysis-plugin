...
type DesignMachineDeclarationParam = { id: DesignMachineIdentifier; attrPath: string; initial: InitialStates; transitions: DesignTransitionDeclarations; ignores: DesignIgnoreDeclarations };
