...
export class ScenarioBinding {
  ...
  private constructor(path: AttributePath, value: BindingValue) { this.#path = path; this.#value = value; }
  static of(path: AttributePath, value: BindingValue): ScenarioBinding { return new ScenarioBinding(path, value); }
