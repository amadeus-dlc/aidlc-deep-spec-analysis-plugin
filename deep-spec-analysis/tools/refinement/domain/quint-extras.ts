...
export interface RefinementQuintExtra {
  reqId: string;
  frRefs: string[];
  expr: Expression;
}

export function refinementQuintExtras(plan: UnitRefinementPlan, req: RefinementRequirements): RefinementQuintExtra[] {
  const out: RefinementQuintExtra[] = [];
