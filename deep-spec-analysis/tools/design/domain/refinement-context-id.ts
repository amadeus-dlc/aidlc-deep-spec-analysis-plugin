// RefinementContextId — Phase 3（refinement）随伴文脈集約の識別子。文脈は
...
export class RefinementContextId {
  ...
  static ofModel(model: DesignModelId): RefinementContextId {
    return new RefinementContextId(model);
  }

  equals(other: RefinementContextId): boolean {
