...
installed("tools/kernel/infrastructure/index.ts", "error");
...
installed("tools/requirements/domain/index.ts", "error");
installed("tools/requirements/usecase/index.ts", "error");
installed("tools/requirements/adapter/index.ts", "error");
