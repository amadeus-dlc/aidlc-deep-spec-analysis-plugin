...
- **CD-2** every fenced yaml spec block parses; a block carrying `openapi:`
  must also carry `paths:`. AsyncAPI and shared-schema blocks are checked for
