...
export const DATA_MODEL_DEBT: ReadonlySet<string> = new Set([
  ...
  "design/domain/design-obligation-decl.ts",
  "design/domain/design-obligation.ts",
  "design/domain/design-report-composition.ts",
  "design/domain/design-report-seed.ts",
  "design/domain/design-scenario-decl.ts",
  "design/domain/design-scenario.ts",
  "design/domain/design-skipped.ts",
  "design/domain/design-temporal-decl.ts",
  "design/domain/design-transition-decl.ts",
  ...
  "refinement/domain/refinement-obligation.ts",
  ...
  "refinement/domain/refinement-scenario.ts",
  ...
  "requirements/domain/ir-obligation-decl.ts",
  "requirements/domain/ir-scenario-decl.ts",
  ...
  "requirements/domain/scenario.ts",
